<template>
  ...
  >
    ...
    <SvgHomepageTabletBackgroundShorter
      class="hidden h-full w-full md:block min-[855px]:hidden"
      :fontControlled="false"
      filled
    />
    <SvgHomepageTabletBackgroundKnowledgeRow
      class="hidden h-full w-full min-[855px]:block lg:hidden"
      :fontControlled="false"
      filled
    />
  ...
  <div class="relative flex flex-col">
    <HomeHeader />
    <div class="mt-28 flex flex-col lg:mt-20">
      <div
        class="m-10 h-56 min-[580px]:mr-32 sm:ml-14 lg:ml-20 xl:ml-28 xl:mt-32"
      >
        <SvgMainLogo
          class="w-[70vw] sm:w-[300px] md:w-[40vw] md:max-w-[450px]"
          :fontControlled="false"
          filled
        />
        <p
          class="my-3 max-w-[835px] bg-sc-white/70 text-left text-sm xs:text-base min-[460px]:text-lg lg:max-w-[60vw] min-[1250px]:text-xl xl:text-2xl"
        >
        ...
        <UTooltip :text="$t('tooltip.not_available')">
          <UButton
            :disabled="true"
            style="opacity: 100"
            class="hidden drop-shadow-sc-shadow hover:bg-orange-700 lg:block lg:px-5 lg:py-2 lg:text-base lg:font-bold"
      ...
      <div
        class="mt-14 flex min-h-[710px] w-screen flex-col items-center xs:mt-[25vw] min-[394px]:min-h-[705px] min-[400px]:min-h-[782px] min-[415px]:mt-[33vw] min-[455px]:mt-[40vw] min-[480px]:mt-[20vw] min-[480px]:min-h-[820px] min-[520px]:min-h-[872px] min-[570px]:mt-[33vw] sm:mt-[10vw] sm:min-h-[650px] min-[660px]:mt-[15vw] min-[684px]:mt-[10vw] min-[720px]:mt-[5vw] min-[855px]:min-h-[350px] lg:mt-[15vw]"
      >
        <h2
          class="mb-5 bg-sc-white/70 font-heading text-xl font-bold text-sc-orange min-[480px]:text-2xl min-[720px]:mb-8 min-[720px]:text-3xl min-[1250px]:text-4xl xl:mb-16 xl:text-6xl"
        >
          {{ $t("homepage.build_your_scrum_knowledge") }}
        </h2>
        <div
          class="flex flex-col justify-center gap-6 min-[490px]:gap-[6vw] sm:mx-10 sm:flex-row sm:flex-wrap min-[855px]:gap-[4vw]"
        >
          <div
            class="w-52 max-w-[275px] rounded-lg border border-sc-black bg-sc-black-50 p-4 drop-shadow-sc-shadow min-[480px]:w-[55vw] sm:w-[224px] lg:w-[260px] xl:w-80"
          >
            <h3
              class="font-heading text-xl min-[520px]:text-2xl xl:mb-3 xl:text-3xl"
            >
              {{ $t("homepage.features.learn_scrum.title") }}
            </h3>
            <p class="text-xs min-[400px]:text-sm min-[480px]:text-base">
              {{ $t("homepage.features.learn_scrum.description") }}
            </p>
            <div class="flex justify-end">
              <SvgScrumProcessIllustration
                class="h-16 min-[520px]:h-20 sm:h-16 xl:h-28"
                :fontControlled="false"
                filled
              />
            </div>
          ...
          >
            ...
            <p class="mb-1 text-xs min-[400px]:text-sm min-[480px]:text-base">
          ...
          <div
            class="w-52 max-w-[275px] rounded-lg border border-sc-black bg-sc-black-50 p-4 drop-shadow-sc-shadow min-[480px]:w-[55vw] sm:w-[224px] lg:w-[260px] xl:mb-6 xl:w-80"
          >
            <h3
              class="font-heading text-xl min-[520px]:text-2xl xl:mb-3 xl:text-3xl"
            >
      ...
      <div class="w-screen">
        ...
        >
          ...
          <p
            class="mb-4 bg-sc-white/70 text-sm min-[394px]:text-base min-[480px]:text-lg sm:text-base min-[720px]:text-lg lg:text-xl xl:mb-6 xl:text-2xl"
          ...
          <UTooltip :text="$t('tooltip.not_available')">
            <UButton
              :disabled="true"
              style="opacity: 100"
              class="drop-shadow-sc-shadow hover:bg-orange-700 lg:px-5 lg:py-2 lg:text-base lg:font-bold"
              >{{ $t("homepage.scrum_guide") }}</UButton
            ></UTooltip
          >
        </div>
      ...
      <div class="flex w-screen flex-col items-end sm:px-[5vw]">
        <div
          class="mx-10 mb-16 mt-20 max-w-[475px] text-right xs:mb-[20vw] xs:mt-[23vw] min-[370px]:mt-[30vw] min-[400px]:mb-[25vw] min-[400px]:mt-[20vw] min-[410px]:mt-[27vw] min-[435px]:mt-[34vw] min-[470px]:mb-[45vw] min-[480px]:mb-[28vw] min-[480px]:mt-[13vw] min-[530px]:mt-[18vw] min-[600px]:mt-[30vw] sm:mb-[9vw] sm:mt-[7vw] min-[720px]:mt-[12vw] md:mt-[10vw] min-[830px]:mb-[12vw] min-[830px]:mt-[15vw] min-[855px]:mt-[12vw] lg:mb-[15vw] min-[1100px]:mt-[15vw]"
        >
          <h5
          ...
          <p
            class="mb-5 bg-sc-white/70 pl-20 text-sm min-[400px]:text-base min-[480px]:text-lg lg:text-xl xl:mb-7 xl:bg-sc-white/0 xl:text-2xl"
          >
