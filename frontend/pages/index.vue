<template>
  ...
  <div class="relative flex flex-col">
    ...
    <div class="mt-28 flex flex-col lg:mt-20 xl:mt-[8vw]">
      <div
        class="m-10 h-56 min-[580px]:mr-32 sm:ml-14 lg:ml-20 xl:ml-28 min-[1330px]:mr-[38vw]"
      >
        <SvgMainLogo
          class="w-[70vw] sm:w-[300px] md:w-[40vw] md:max-w-[450px] lg:max-w-[520px] xl:max-w-[590px]"
          :fontControlled="false"
          filled
        />
        <p
      ...
      >
        ...
        >
          <div
            class="w-52 max-w-[275px] rounded-lg border border-sc-black bg-sc-black-50 p-4 drop-shadow-sc-shadow min-[480px]:w-[55vw] sm:w-[224px] lg:w-[260px] min-[1400px]:w-80 min-[1400px]:max-w-none"
          >
            <h3
              class="font-heading text-xl min-[520px]:text-2xl xl:mb-3 xl:text-3xl min-[1400px]:text-4xl"
            >
            ...
            <div class="flex justify-end">
              <SvgScrumProcessIllustration
                class="h-16 min-[520px]:h-20 sm:h-16 xl:h-24"
                :fontControlled="false"
                filled
              />
            </div>
