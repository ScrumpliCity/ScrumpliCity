...
<template>
  ...
  <div class="mr-[14.5vw] flex flex-col items-center gap-12">
    <h1 class="font-heading text-5xl font-bold text-sc-orange">
      {{ $t("join-room.ready.waiting_for_start") }}
    </h1>
    <div class="flex items-start gap-20">
      ...
      >
        <h2 class="self-center font-heading text-3xl font-bold text-sc-orange">
          {{ $t("join-room.ready.team_members") }}
        </h2>
      ...
      >
        <h2 class="self-center font-heading text-3xl font-bold text-sc-orange">
          {{ $t("join-room.ready.room_settings") }}
        </h2>
        <div>
          <ul
          ...
          >
            <li>
              <strong class="font-semibold text-gray-800"
                >{{ $t("join-room.ready.sprint_count") }}:
              </strong>
              {{ sprintCount }}
            </li>
            <li>
              <strong class="font-semibold text-gray-800"
                >{{ $t("join-room.ready.sprint_duration") }}:
              </strong>
              {{ sprintDuration }}
            </li>
            <li>
              <strong class="font-semibold text-gray-800"
                >{{ $t("join-room.ready.meeting_duration") }}:
              </strong>
              {{ meetingDuration }}
            </li>
          </ul>
